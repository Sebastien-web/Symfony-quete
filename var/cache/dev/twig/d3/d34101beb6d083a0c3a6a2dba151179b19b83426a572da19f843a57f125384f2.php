...
class __TwigTemplate_8b4b89f289d870f5ed31e239ec50d46c360b76a9c28093a92dd49e219a54c00d extends \Twig\Template
{
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["actor"]) {
            // line 32
            echo "        <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("actor_show", ["id" => twig_get_attribute($this->env, $this->source, $context["actor"], "id", [], "any", false, false, false, 32)]), "html", null, true);
            echo "\">
            <li>";
            // line 33
    ...
    <a href=\"";
        // line 44
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("program_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["program"]) || array_key_exists("program", $context) ? $context["program"] : (function () { throw new RuntimeError('Variable "program" does not exist.', 44, $this->source); })()), "id", [], "any", false, false, false, 44)]), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return array (  168 => 46,  163 => 44,  158 => 42,  152 => 38,  145 => 36,  137 => 33,  132 => 32,  127 => 31,  117 => 24,  110 => 20,  103 => 16,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "program/show.html.twig", "/home/sebastien/Documents/Wild_Code_School/Exercices/Symfony_quete/wild-series/templates/program/show.html.twig");
    }
}
